...
export default function ModernFooter() {
  return (
    <footer className="bg-surface border-t border-border py-8  sm:py-16  px-3 sm:px-6 lg:px-8">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-6">
              <div className="relative w-10 h-10">
                ...
                <div className="absolute inset-[3px] bg-surface rounded-lg flex items-center justify-center text-foreground font-bold">
                  N
                </div>
              </div>
