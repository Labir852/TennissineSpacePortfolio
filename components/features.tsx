...
export default function ModernFeatures() {
  ...
  return (
    <section id="features" className="py-12 px-4 sm:py-16 md:py-24 bg-background relative">
      {/* Background elements */}
      ...
      <div className="container mx-auto relative z-10">
        ...
        <Tabs defaultValue="analytics" value={activeTab} onValueChange={handleTabChange} className="w-full">
          <div className="flex justify-center mb-6 sm:mb-8 overflow-x-auto pb-3 sm:pb-0 scrollbar-hide">
            <TabsList className="bg-white/5 backdrop-blur-sm border border-border/10 p-1 rounded-xl flex-nowrap">
